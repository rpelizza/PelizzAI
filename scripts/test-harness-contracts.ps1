...
try {
    ...
    Check-Match '.claude/skills/pelizzai-discovery/SKILL.md' 'deliver the question through it' 'discovery: native delivery is preferred, not tolerated'
    Check-Match '.claude/skills/pelizzai-discovery/SKILL.md' 'the block is the prose fallback' 'discovery: prose block is the fallback'
    Check-Match '.claude/skills/pelizzai-discovery/SKILL.md' 'native or prose, follows the conversation' 'discovery: questions follow the conversation language in both deliveries'
    Check-Match '.claude/skills/pelizzai-router/SKILL.md' 'adjust as the alternative' 'router: adjust stays the visible alternative'
    Check-Match '.claude/skills/pelizzai-router/SKILL.md' 'the block is the prose fallback' 'router: prose block is the fallback'
