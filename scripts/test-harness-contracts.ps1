...
try {
    ...
    Check-Match '.claude/skills/pelizzai-verify/SKILL.md' 'service-starts\s+row\s+is\s+mandatory\s+when\s+the\s+diff\s+touches\s+initialization' 'verify: service-starts is mandatory for boot-touching diffs'
    ...
    Check-Match '.claude/skills/pelizzai-evolve/templates/verification-standard.md' '\| Surface \| Bring-up' 'verification-standard template: bring-up table has the per-surface header'
