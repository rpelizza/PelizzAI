...
try {
    ...
    try {
        ...
        $legacyClaude = "# CLAUDE.md`n`n## PelizzAI harness (mandatory entry point)`n`nThis repository consumes PelizzAI. (old wholesale export)`n`n## Behavioral guidelines`n`nold contract body`n`nSigns in the opposite direction are a trigger to revise the skills — not to abandon them.`n`n## My project notes`n`nlegacy-tail-sentinel`n"
