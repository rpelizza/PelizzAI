...
`;
  // The markers are a container, not content. In a consumer CLAUDE.md carries them, and copying
  // them into the generated body would nest a block inside a block — which readManaged then reads
  // to the FIRST end marker, silently truncating the doctrine it is supposed to compare.
  const body = readText(claudeMd)
    .split('\n')
