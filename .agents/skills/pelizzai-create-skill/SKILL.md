...
- `pelizzai-interview` / `pelizzai-idea-generation` — the new-project branch, before creating the first skills.
- `pelizzai-writing-clearly` — write skill bodies with clarity.
