 ...
 * the cadence core lives in the `pelizzai-create-skill` skill (portable across IDEs)
...
function main() {
  ...
  emit(
    `PelizzAI (cadence): ${parts.join('; ')}. ` +
      `Consider invoking the pelizzai-create-skill skill (maintenance mode) to review/update ` +
