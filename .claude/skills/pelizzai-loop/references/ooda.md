...
- `pelizzai-diagnose` — uses OODA only as a macro lens when the investigation genuinely requires rounds; a direct cause or a short deterministic bug does not need it.
