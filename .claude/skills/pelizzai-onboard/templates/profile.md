...
> Detected by `pelizzai-onboard` at bootstrap, reading the project's REAL scripts
...
> `pelizzai-diagnose` (feedback loop), and `pelizzai-skill-lab` (Stack baseline
...
_Anchor of the version-driven and adoption-driven axes of `pelizzai-skill-lab`:
