...
function writeManaged(path, content) {
  ...
  // "GENERATED by scripts/sync-harness" header and has no markers. Appending would leave TWO
  // copies of the doctrine — the stale one on top, with a skill list that no longer exists. A
  // wholly generated file is replaced; only genuine project-authored text earns the append. The
  // header is only trusted at the very top: authored text that merely MENTIONS it stays authored.
  if (/^\s*<!--\s*GENERATED by scripts\/sync-harness/.test(existing)) {
