...
Choosing this mode already proves the environment can dispatch; if the capability is LOST mid-run
(quota, ceiling, restricted resumption), it does not become an inline review — go through
