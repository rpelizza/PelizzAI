...
Regression scenario for `pelizzai-resume`. Run it WITHOUT showing the agent the correct answer. Every behavioral change to this skill re-runs this scenario before and after the edit.
